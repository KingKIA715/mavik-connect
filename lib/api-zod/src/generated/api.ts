...
export const ListGroupsResponseItem = zod.object({
  ...
  "isMuted": zod.boolean().describe('Whether the current user has muted notifications for this group. Purely personal, like isPinned — never affects sending or receiving messages.\n')
})
...
export const GetGroupResponse = zod.object({
  ...
  "createdAt": zod.string(),
  "avatarUrl": zod.string().nullish(),
  "isMuted": zod.boolean().describe('Whether the current user has muted notifications for this group. Purely personal — never affects sending or receiving messages.\n'),
...
export const ListDmThreadsResponseItem = zod.object({
  ...
  "isMuted": zod.boolean().describe('Whether the current user has muted notifications for this thread. Per-side, like isPinned — never affects sending or receiving messages.\n')
})
