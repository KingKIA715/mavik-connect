 ...
 */
export const setGroupMuted = async (groupId: string,
    setMutedInput: SetMutedInput, options?: RequestInit): Promise<MutedResult> => {
...
export const getSetGroupMutedMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof setGroupMuted>>, TError,{groupId: string;data: BodyType<SetMutedInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof setGroupMuted>>, TError,{groupId: string;data: BodyType<SetMutedInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof setGroupMuted>>, {groupId: string;data: BodyType<SetMutedInput>}> = (props) => {
          const {groupId,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type SetGroupMutedMutationResult = NonNullable<Awaited<ReturnType<typeof setGroupMuted>>>
 ...
 * @summary Mute or unmute a group for the current user
 */
export const useSetGroupMuted = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof setGroupMuted>>, TError,{groupId: string;data: BodyType<SetMutedInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
 ...
 */
export const setDmThreadMuted = async (threadId: string,
    setMutedInput: SetMutedInput, options?: RequestInit): Promise<MutedResult> => {
...
export const getSetDmThreadMutedMutationOptions = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof setDmThreadMuted>>, TError,{threadId: string;data: BodyType<SetMutedInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof setDmThreadMuted>>, TError,{threadId: string;data: BodyType<SetMutedInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof setDmThreadMuted>>, {threadId: string;data: BodyType<SetMutedInput>}> = (props) => {
          const {threadId,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type SetDmThreadMutedMutationResult = NonNullable<Awaited<ReturnType<typeof setDmThreadMuted>>>
 ...
 * @summary Mute or unmute a DM thread for the current user
 */
export const useSetDmThreadMuted = <TError = ErrorType<void>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof setDmThreadMuted>>, TError,{threadId: string;data: BodyType<SetMutedInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
